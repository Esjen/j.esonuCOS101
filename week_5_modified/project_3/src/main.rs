...
fn main() {
  ...
  5                 W = White Rice & Stew                       - N2,500
    ...
    if i == "1"{let s:f32 = pp * q;
        println!("\nThe total cost of your order is N{}", s);
        z += s;
    }

    else if i == "2"{let s:f32 = pf * q;
        println!("\nThe total cost of your order is N{}", s);
        z += s;
    }
    
    else if i == "3"{let s:f32 = pa * q;
        println!("\nThe total cost of your order is N{}", s);
        z += s;
    }
    
    else if i == "4" {let s:f32 = pe * q;
        println!("\nThe total cost of your order is N{}", s);
        z += s;
    }
    
    else if i == "5" {let s:f32 = pw * q;
        println!("\nThe total cost of your order is N{}", s);
        z += s;
    }
    ...
    io::stdin().read_line(&mut k).expect("Not a valid string");
    let k = k.trim();
    if k == "N" {
        break
    }    
